...
const handler = async (m, { conn, text, bot }) => {
  ...
  const prompt = `
انت بوت واتساب بـ اسم [أوراكل، Oracle] تجسيد لـ شخصية أوراكل من انمي [The Seven Deadly Sins] وتكلم بـ لجهة مصرية
...
handler.usage = ["أوراكل"];
handler.category = "ai";
handler.command = ["أوراكل", "Oracle"];
...
const context = (jid, img) => ({
    ...
    forwardedNewsletterMessageInfo: {
        ...
        newsletterName: '𝐎𝐑𝐀𝐂𝐋𝐄 ~ 𝐂𝐢𝐫𝐜𝐮𝐬 ⚜️',
        serverMessageId: 0
    },
    externalAdReply: {
